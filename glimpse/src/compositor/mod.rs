...
pub use protocol::{
    ...
    KeyboardLayoutState, WorkspacePresentation, WorkspaceSlot, WorkspaceSnapshot, WorkspaceState,
    WorkspaceWindow, detect, focus_notification_target, short_layout_name,
};
